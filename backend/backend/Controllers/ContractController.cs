...
namespace backend.Controllers
{
    ...
    public class ContractController : ControllerBase
    {
        ...
        public ContractController(IContractService contractService, IRoomService roomService,
            IExportService exportService, ICurrentUser currentUser, IUserService userService,
        ...
        public async Task<FileStreamResult> ExportAction([FromBody] CreateUpdateContractDto contractDto)
        {
            ...
            var wookbook = await _exportService.ExportWord(dataReplace, null,
                "https://res.cloudinary.com/khanh15032001/raw/upload/v1709479161/documents/templateContract_kgsu6u.doc");
            return WorkbookUtil.DocumentToFileStream(wookbook, "Hop-dong-cho-thue-nha.docx");
        }

        [HttpPost("export-contract-mobile")]
        public async Task<FileStreamResult> ExportMobileAction([FromBody] CreateUpdateContractDto contractDto)
        {
            var dataReplace = await _contractService.GetDataExportContractMobile(contractDto);
            var wookbook = await _exportService.ExportWord(dataReplace, null,
                "https://res.cloudinary.com/khanh15032001/raw/upload/v1709479161/documents/templateContract_kgsu6u.doc");
            return WorkbookUtil.DocumentToFileStream(wookbook, "Hop-dong-cho-thue-nha.docx");
        }
